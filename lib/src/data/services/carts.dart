...
class CartsResource extends BaseResource {
  ...
  Future<StoreCartsRes?> addShippingMethod({required String cartId,
    ...
    try {
      ...
      final response =
          await client.post('/store/carts/$cartId/shipping-methods', data: req);
  ...
  Future<StoreCartsRes?> createCart(
  ...
  /// @param customHeaders
  /// @return {ResponsePromise<StoreCartsRes>}
  Future<StoreCartsRes?> deleteDiscount({required String cartId,
    String? code,
    Map<String, dynamic>? customHeaders}) async {
    try {
      if (customHeaders != null) {
      ...
      final response =
          await client.delete('/store/carts/$cartId/discounts/$code');
      if (response.statusCode == 200) {
        return StoreCartsRes.fromJson(response.data);
      } else {
        throw response;
  ...
  /// @param customHeaders
  /// @return {ResponsePromise<StoreCartsRes>}
  Future<StoreCartsRes?> deletePaymentSession({required String cartId,
    ...
    try {
      ...
      final response = await client
          .delete('/store/carts/$cartId/payment-sessions/$providerId');
      if (response.statusCode == 200) {
        return StoreCartsRes.fromJson(response.data);
      } else {
        throw response;
  ...
  /// @param customHeaders
  /// @return {ResponsePromise<StoreCartsRes>}
  Future<StoreCartsRes?> refreshPaymentSession({required String cartId,
    required String providerId,
    Map<String, dynamic>? customHeaders}) async {
    try {
      if (customHeaders != null) {
      ...
      final response = await client
          .post('/store/carts/$cartId/payment-sessions/$providerId/refresh');
      if (response.statusCode == 200) {
        return StoreCartsRes.fromJson(response.data);
      } else {
        throw response;
  ...
  /// @param customHeaders
  /// @return {ResponsePromise<StoreCartsRes>}
  Future<StoreCartsRes?> update({required String cartId,
  ...
  Future<StoreCartsRes?> updatePaymentSession(
    ...
    try {
      ...
      final response = await client
          .post('/store/carts/$cartId/payment-sessions/$providerId', data: req);
      if (response.statusCode == 200) {
        return StoreCartsRes.fromJson(response.data);
      } else {
        throw response;
  ...
  Future<StoreCartsRes?> addLineItem(
    ...
    try {
      ...
      final response =
          await client.post('/store/carts/$cartId/line-items', data: {
  ...
  Future<StoreCartsRes?> deleteLineItem(
    ...
    try {
      ...
      final response =
          await client.delete('/store/carts/$cartId/line-items/$lineId');
      if (response.statusCode == 200) {
        return StoreCartsRes.fromJson(response.data);
      } else {
        throw response;
